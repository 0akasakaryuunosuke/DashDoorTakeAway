package org.mobile.dashdoor.controller;

import cn.hutool.core.util.ObjectUtil;
import com.github.pagehelper.PageInfo;
import org.mobile.dashdoor.common.Result;
import org.mobile.dashdoor.common.enums.ResultCodeEnum;
import org.mobile.dashdoor.entity.Business;
  ...
  @Autowired
    ...
    public Result add(@RequestBody Business business) {
        ...
        if (ObjectUtil.isEmpty(business.getUsername()) || ObjectUtil.isEmpty(business.getPassword())) {
           ...
           String key="status"+ "-"+business.getUsername();
           Integer value=0;
